        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                <div className='col'>
                    ...
                    <p className='mt-3 fs-10'>&copy; 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
                </div>
                <div className='col text-muted'>
                    ...
                    <br></br>
                    <a style={{textDecoration:"none"}} href =''>Open source</a>
                    <br></br>
                ...
                <div className='col text-muted'>
                    ...
                    <br></br>
                    <a style={{textDecoration:"none"}} href =''>Videos</a>
                    <br></br>
                    <a style={{textDecoration:"none"}} href =''>Market overview</a>
                    <br></br>
